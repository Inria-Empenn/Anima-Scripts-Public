...
# # Mask T1 image
#
# MaskT1ImageCommand= [animaScriptBrainDir + "animaAtlasBasedBrainExtraction.py", "-i", T1Image, "-b", outT1Prefix]
# print("\n Brain extraction")
# call(MaskT1ImageCommand, stdout=open(os.devnull, "w"))
# MaskImage=outT1Prefix + "_masked.nii.gz"
#
...
# print(M0MeanImageCommand)
# call(M0MeanImageCommand, stdout=open(os.devnull, "w"))
# M0Image= M0ImagePrefix + "_mean.nii.gz"
